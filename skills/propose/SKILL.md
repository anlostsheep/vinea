...
Only after the user approves the title, risk, quality mode, and execution mode, run the same proposal with `--confirmed`. The flag records a conversation decision; it never replaces obtaining that decision.
